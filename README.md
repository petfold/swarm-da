...
- [`swarm-data-availability.md`](swarm-data-availability.md) — the memo (2026-09-09, verified 2026-09-10), with an appendix mapping loopmarket onto rollup vocabulary.
